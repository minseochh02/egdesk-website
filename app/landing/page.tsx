    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            EGDesk is a revolutionary system that converts your computer into 
            an MCP server and local LLM server, with optional Google Apps Script integration 
            for cloud-based MCP servers — all accessible anywhere with your Google account.
          </p>
          <div className="inline-flex items-center gap-2 px-6 py-3 bg-green-500/20 border border-green-400/50 rounded-full mb-12">
            ...
            <span className="text-green-300 font-semibold">100% Private - Data stays on your PC or your own Google account</span>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/10 hover:border-blue-400/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <ul className="space-y-3 text-gray-300">
                ...
                <li className="flex items-start">
                  ...
                  <span><strong className="text-white">Complete Privacy</strong> - All data stored locally on your PC</span>
                </li>
              </ul>
              <div className="mt-6">
                <a 
            ...
            {/* Part 2: Apps Script MCP */}
            <div className="bg-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/10 hover:border-green-400/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-300 mb-4 leading-relaxed">
                Create cloud-based MCP servers using Google Apps Script. 
                Perfect for when your PC is off or for storing data in Google's ecosystem.
              </p>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-green-400 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span><strong className="text-white">Always Online</strong> - MCP server runs 24/7 without your PC</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-green-400 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span><strong className="text-white">Google Integration</strong> - Store data in Sheets, Drive, or Docs</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-green-400 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span><strong className="text-white">Your Account</strong> - Data stays in your own Google account</span>
                </li>
              </ul>
              <div className="mt-6">
                <Link 
                  href="/docs/apps-script"
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/10 hover:border-purple-400/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-300 mb-4 leading-relaxed">
                Access your AI servers from anywhere using our web interface. 
                Simply sign in with your Google account and connect.
              </p>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-green-400 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <li className="flex items-start">
                  ...
                  <span><strong className="text-white">Google OAuth</strong> - Secure authentication</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-green-400 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span><strong className="text-white">Unified Dashboard</strong> - Manage all your MCP servers</span>
                </li>
              </ul>
              <div className="mt-6">
                <Link 
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">Data stays on your PC or your own Google account</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Always Online</h3>
              <p className="text-gray-300">Apps Script MCP runs 24/7 in the cloud</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="bg-white/5 backdrop-blur-lg rounded-3xl p-12 border border-green-400/30">
            ...
            <p className="text-xl text-gray-300 text-center mb-6 leading-relaxed">
              <strong className="text-white">EGDesk never stores your data on our servers.</strong> Everything runs either 
              on your local PC or in your own Google account (when using Apps Script). We only facilitate 
              secure connections between your devices. Your privacy is absolute.
            </p>
            <div className="flex flex-wrap justify-center gap-4 text-green-300">
              <div className="flex items-center gap-2">
                ...
                <span>No cloud storage by EGDesk</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              ...
              <div className="flex items-center gap-2">
                ...
                <span>You own your Google data</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Download the desktop app for local AI, set up Apps Script for cloud MCP, 
            and access your personal AI servers from anywhere.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="https://github.com/minseochh02/egdesk-scratch/releases"
      ...
      <footer className="py-8 px-6 border-t border-white/10">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400">&copy; 2025 EGDesk by QUUS. Transform your PC into a powerful AI server.</p>
